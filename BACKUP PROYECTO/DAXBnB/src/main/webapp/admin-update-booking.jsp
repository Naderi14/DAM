...
<body>
    ...
    <form method="post">
        <div class="col-12 my-3">
            <label for="idBookingForUpdate" class="form-label">Select ID Booking</label>
            <input type="hidden" name="action" value="update-booking"/>
            <select class="form-select" name="idBookingForUpdate" id="idBookingForUpdate" required="">
        ...
        <button class="w-100 btn btn-success btn-lg" type="submit">Select</button>
    </form>
</body>
</html>
